...
class PredictView(FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Obesity Prediction using KNN'
        return context
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            # Define obesity category mapping
            obesity_categories = {
            ...
            try:
                model = joblib.load('knn/model/knn_model.pkl')
                scaler = joblib.load('knn/model/scaler.pkl')
                ...
                category = obesity_categories.get(prediction_num, "Unknown Category")
                ...
                prediction = f"Category: {category} (BMI: {bmi_rounded})"
        ...
        context = {
            'form': form,
            'title': 'Obesity Prediction using KNN',
